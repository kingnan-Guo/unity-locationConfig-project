...
public class gloab_TagName
{
    ...
    /// canvas 上的 device 禁用状态,已经 拖拽到 三位场景中
    /// </summary>
    public static string CANVAS_BUILDING = "2dButton";


    // CANVAS_UNDER_GROUND_BUTTON
    /// <summary>
    /// canvas 上的 地下按钮
    /// </summary>
    public static string CANVAS_UNDER_GROUND_BUTTON = "2dUnderGroundButton";
    ...
    /// 地下标签
    /// </summary>
    public static string UNDER_GROUND = "UnderGround";
