...
public class RotateAxes123 : AxesBaseClass
{
    ...
    protected override void OnDrag(){
        ...
        if(Input.GetMouseButton(0) && DragState == DragStateType.mouseButtonDown){
            ...
            // Debug.Log("currentPosition =="+ currentPosition + "=====" + currenthitRayPoint);
            ...
            if (XYZAxisTransform.TryGetComponent(out LineRenderer line)){
                ...
                case AxisType.Y:
                    ...
                    float angle = Vector3.Angle((currenthitRayPoint - initialPosition), tempPos);

                    Vector3 cross = Vector3.Cross((currenthitRayPoint - initialPosition), tempPos);
