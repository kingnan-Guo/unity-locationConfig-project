...
public class RotateAxes_3 : AxesBaseClass
{
        ...
        if(Input.GetMouseButton(0) && DragState == DragStateType.mouseButtonDown){
            ...
            if (XYZAxisTransform.TryGetComponent(out LineRenderer line)){
                ...
                case AxisType.Z:
                    ...
                    tempPos = Vector3.Project((currentPosition-initialPosition), transform.right) + Vector3.Project((currentPosition-initialPosition), transform.up);
                    ...
                    angle = Vector3.Angle(Vector3.Normalize(tempPos2), Vector3.Normalize(tempPos));
                    ...
                    if((int)Mathf.Sign(Vector3.Cross(Vector3.Normalize(tempPos2), Vector3.Normalize(tempPos)).z) < 0){
                        angle = -angle;
                    }
                ...
                case AxisType.X:
                    ...
                    tempPos = Vector3.Project((currentPosition-initialPosition), transform.forward) + Vector3.Project((currentPosition-initialPosition), transform.up);
                    ...
                    if((int)Mathf.Sign(Vector3.Cross(Vector3.Normalize(tempPos2), Vector3.Normalize(tempPos)).x) < 0){
                        angle = -angle;
                    }
