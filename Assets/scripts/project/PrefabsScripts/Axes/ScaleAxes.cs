...
public class ScaleAxes : AxesBaseClass
{
    ...
    protected override void OnDrag(){
        ...
        if(Input.GetMouseButtonDown(0)){
            ...
            parentOriginalScale = currentAxisParent.transform.localScale;
        ...
        if(Input.GetMouseButton(0)){
            ...
            currentAxisParent.transform.localScale = new Vector3(1,1,1) + tempPos;
            // transform.localScale = Quaternion.identity;


            var currentParentScale = currentAxisParent.localScale;
            var diffX = currentParentScale.x / parentOriginalScale.x;
            var diffY = currentParentScale.y / parentOriginalScale.x;
            var diffZ = currentParentScale.z / parentOriginalScale.x;
            var diffVector = new Vector3 (1/diffX, 1/diffY, 1/diffZ);
            transform.localScale = 1 * diffVector;
