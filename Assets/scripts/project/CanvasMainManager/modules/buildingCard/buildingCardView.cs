...
public class buildingCardView : baseManager<buildingCardView>
{
    ...
    public void showBuildingCardView(Dictionary<string, object> res){
        ...
        res.ToList().ForEach((item) => {
            ...
            // 创建楼幢卡片
            Button btn = createButton(info.name, info.name, BuildingCard);
    ...
    public void ButtonClicked(string name){
        // Debug.Log("ButtonClicked = "+ ((buildingInfo)GameMainManager.GetInstance().buildingDictionary[name]).position);
    ...
    public void showFloorCardView(string name){
        floorList[] floorList = (floorList[])(((buildingInfo)GameMainManager.GetInstance().buildingDictionary[name]).floorList);
    ...
    public Button createButton(string name, string showText, Transform parent){
     // 创建按钮
