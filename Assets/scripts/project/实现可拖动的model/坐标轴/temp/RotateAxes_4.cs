...
public class RotateAxes_4 : AxesBaseClass
{
            ...
            if (XYZAxisTransform.TryGetComponent(out LineRenderer line)){
                ...
                switch (axisType)
                {
                    ...
                    case AxisType.Z:
                        ...
                        tempPos0 = Vector3.Project((currentPosition-initialPosition), transform.right) + Vector3.Project((currentPosition-initialPosition), transform.up);
                        tempPos2 = Vector3.Project((currenthitRayPoint-initialPosition), transform.right) + Vector3.Project((currenthitRayPoint-initialPosition), transform.up);
                        ...
                        if(temp.z != angle){
                            // currentAxisParent.transform.localEulerAngles = currentAxisParent.transform.localEulerAngles - new Vector3(0, 0, temp.z- angle);
                        ...
                        break;
                    case AxisType.Y:
                        tempPos0 = Vector3.Project((currentPosition-initialPosition), transform.right) + Vector3.Project((currentPosition-initialPosition), transform.forward);
                        ...
                        break;
                    case AxisType.X:
                        tempPos0 = Vector3.Project((currentPosition-initialPosition), transform.forward) + Vector3.Project((currentPosition-initialPosition), transform.up);
                        tempPos2 = Vector3.Project((currenthitRayPoint-initialPosition), transform.forward) + Vector3.Project((currenthitRayPoint-initialPosition), transform.up);
                        angle = Vector3.Angle(Vector3.Normalize(tempPos2), Vector3.Normalize(tempPos0));
                        ...
                        if(temp.x != angle){
                            // currentAxisParent.transform.localEulerAngles = currentAxisParent.transform.localEulerAngles - new Vector3(temp.x - angle, 0, 0);
                ...
                // currentAxisParent.transform.localRotation =  currentAxisParent.transform.localRotation + QuaternionEulerValue;

                // currentAxisParent.transform.localEulerAngles =  QuaternionEulerValue;

                // temp = temp + QuaternionEulerValue;
                
                transform.rotation = Quaternion.identity;


                
                // currentAxisParent.transform.RotateAround(currentAxisParent.transform.position, Vector3.up, angle);
            }
        }
    ...
    public class DataProcessor
    {
        ...
        private float _lastProcessedData;
